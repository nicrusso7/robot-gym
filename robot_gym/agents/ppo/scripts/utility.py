...
from robot_gym.agents.ppo.tools import simulate, count_weights, wrappers
from robot_gym.agents.ppo.tools.attr_dict import AttrDict
from robot_gym.agents.ppo.tools.batch_env import BatchEnv
from robot_gym.agents.ppo.tools.in_graph_batch_env import InGraphBatchEnv
...
def define_simulation_graph(batch_env, algo_cls, config):
  ...
  """
    ...
    done, score, summary = simulate.simulate(batch_env, algo, should_log, force_reset)
    message = 'Graph contains {} trainable variables.'
    tf.compat.v1.logging.info(message.format(count_weights.count_weights()))
