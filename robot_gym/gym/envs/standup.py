...
class RobotStandupEnv(rex_gym_env.RobotGymEnv):
  ...
  """
    ...
    def reset(self):
        super(RobotStandupEnv, self).reset(initial_motor_angles=rex_constants.INIT_POSES['rest_position'],
                                           reset_duration=0.5)
    ...
    def _transform_action_to_motor_command(self, action):
        ...
        action = super(RobotStandupEnv, self)._transform_action_to_motor_command(action)
        return action
