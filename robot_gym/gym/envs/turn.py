...
from robot_gym.model.robots.spotmicro import rex_constants
...
class RobotTurnEnv(rex_gym_env.RobotGymEnv):
    ...
    def __init__(self,
        ...
        Args:
          ...
          log_path: The path to write out logs. For the details of logging, refer to
            rex_logging.proto.
        """
        super(RobotTurnEnv, self).__init__(
            debug=debug,
    ...
    def reset(self):
        ...
        super(RobotTurnEnv, self).reset(initial_motor_angles=self.init_pose, reset_duration=0.5)
        ...
        self.pybullet_client.resetBasePositionAndOrientation(self.rex._quadruped, position, q)
    ...
    def _transform_action_to_motor_command(self, action):
        ...
        action = super(RobotTurnEnv, self)._transform_action_to_motor_command(action)
        return action
