...
REX_DEFAULT_ABDUCTION_ANGLE = 0
REX_DEFAULT_HIP_ANGLE = 0.67
REX_DEFAULT_KNEE_ANGLE = -1.25

INIT_MOTOR_ANGLES = np.array(
    [
        REX_DEFAULT_ABDUCTION_ANGLE,
        REX_DEFAULT_HIP_ANGLE,
        REX_DEFAULT_KNEE_ANGLE
    ] * 4)
